...
* @(#) $Id: email.class.php $
* 
* Classs to assist in building mime-HTML eMails
*
* @package email 
*
...
* @license   Released under the GNU General Public License
  ...
  and can be found here: http://www.phpguru.org
   ...
   Modified by Jan Wildeboer for osCommerce
*/
if(!defined('IN_ECX')){
 ...
 */
    ...
    function add_text($text = '') {
      $this->text = ecx_convert_linefeeds(array("\r\n", "\n", "\r"), $this->lf, $text);
    }
 ...
 */
    ...
    function add_html($html, $text = NULL, $images_dir = NULL) {
      $this->html = ecx_convert_linefeeds(array("\r\n", "\n", "\r"), '<br />', $html);
      $this->html_text = ecx_convert_linefeeds(array("\r\n", "\n", "\r"), $this->lf, $text);
...
//    function build_message($params = array()) {
    function build_message($params = '') {
      ...
      if (ecx_not_null($this->html_images)) {
      ...
      $null = NULL;
      $attachments = ((ecx_not_null($this->attachments)) ? true : false);
      $html_images = ((ecx_not_null($this->html_images)) ? true : false);
      $html = ((ecx_not_null($this->html)) ? true : false);
      $text = ((ecx_not_null($this->text)) ? true : false);
...
//          $message =& $this->add_mixed_part();
        ...
        case (($html == true) && ($attachments == false) && ($html_images == false)):
          if (ecx_not_null($this->html_text)) {
/* HPDL PHP3 */
