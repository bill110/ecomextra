...
die ("Illegal access attempt");
  ...
  class language {
    ...
    function language($lng = '') {
      ...
      $languages_query = ecx_db_query("select languages_id, name, code, image, directory from " . TABLE_LANGUAGES . " order by sort_order");
      while ($languages = ecx_db_fetch_array($languages_query)) {
    ...
    function set_language($language) {
      if ( (ecx_not_null($language)) && (isset($this->catalog_languages[$language])) ) {
  ...
  /** used to extend language class */
  do_action('extend_language');
?>